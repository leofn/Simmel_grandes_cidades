---
title: "**As grandes cidades e a vida do espírito - 1903**"
subtitle: "**Georg Simmel**"
author:
- Leonardo Nascimento (PPGCS/LABHDUFBA)
date: "`r Sys.Date()`"
encoding: "UTF-8"
output:
...
--
## 1) Assim eram definidas as cidades que tinham mais de cem mil habitantes. 
<br>
...
## 1) Aumento quantitativo e mudanças qualitativas!
